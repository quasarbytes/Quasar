          ...
          <ul className="navbar-nav m-auto mb-2 mb-lg-0">
            <li className="nav-item dropdown" onMouseMove={handleMouseMove} onMouseLeave={handleMouseLeave}>
              ...
              <ul className="dropdown-menu" aria-labelledby="navbarDropdown1">
                <li><Link to="/home-app-landing" className="dropdown-item">صفحة هبوط للتطبيق</Link></li>
                <li><Link to="/home-saas-technology" className="dropdown-item">التكنولوجى</Link></li>
                <li><Link to="/home-marketing-startup" className="dropdown-item">التسويق الالكترونى</Link></li>
              </ul>
            </li>
            <li className="nav-item dropdown" onMouseMove={handleMouseMove} onMouseLeave={handleMouseLeave}>
